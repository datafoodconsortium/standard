...
* Added product names
* Added a second nutrient (Salt) to the product item3
* Added a second physical characteristic to the product item3
* Fixed the `dfc-b:hasAllergenCharacteristic` part of the product item3 (hasAllergenDimension + hasUnit for the first product)
* Changed the expiration dates, sku, product descriptions to be more realistic
* Removed one of the brand description in `brandId1`
