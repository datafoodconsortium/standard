...
You will find here the list of the different general decisions and choices made during the build of the DFC Standard. It is ordered from the most recent one to the oldest one.

* [Federation vs Syndication](federation-vs-syndication.md)
