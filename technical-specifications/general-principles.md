...
- Interopérabilité base sur le web sémantique normalisées W3C ce qui inclue protocole Sémantique et Ontologies -&gt; Protocole Specification  
...
- Cette intarction doi être sécurisé \(la platforme\) -&gt; Authentification  
